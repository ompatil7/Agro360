...
import {
    User, Mail, Phone, MapPin, Shield, Calendar, Edit2, Check,
    Home, Building2, MapPinned, Camera, X, Loader2,
    FileText,
    Download
} from 'lucide-react';
        ...
        >
            ...
            <div className="grid grid-cols-3 gap-8">
                        ...
                        <div className="flex items-start space-x-6">
                            <div className="relative group">
                                <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-mycol-celadon shadow-md transition-transform group-hover:scale-105">
                                    <img
                                        src={photoPreview || (user.photo !== "default.jpg" ? user.photo : "https://via.placeholder.com/100")}
                                        alt="Profile"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {isEditing ? (
                                            ...
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <span className="text-gray-700">{user.phone || 'Not specified'}</span>
                                            </div>
                                        )}
                                    </div>
                                </div>
                ...
                <div className="space-y-6">
                    ...
                    >
                        <h3 className="text-xl font-semibold text-gray-800 mb-6">Account Status</h3>
