...
const ThresholdResult = ({ satisfied, message }) => (
    <motion.div
        whileHover={{ x: 10 }}
        className={`flex items-start space-x-3 p-5 rounded-xl border ${satisfied
            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                {/* Claim Response */}
                {
                    claimResponse && (
                        ...
                        >
                            {/* Status Banner */}
                            <div className={`p-6 rounded-xl ${claimResponse.claim.status === 'approved'
                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h2 className="text-xl font-semibold text-gray-900">
                                                Claim {claimResponse.claim.status === 'approved' ? 'Approved' : 'Rejected'}
                                            </h2>
                                            <p className="text-gray-600 mt-1">
                                                Submitted on {new Date(claimResponse.claim.createdAt).toLocaleDateString()}
                                            </p>
                                        </div>
                                    </div>
                                    <div className={`px-4 py-2 rounded-full text-sm font-medium ${claimResponse.claim.status === 'approved'
                            ...
                            {/* Threshold Results */}
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                <h3 className="text-lg font-semibold text-gray-900 mb-4">Threshold Analysis</h3>
                                <div className="space-y-4">
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <p className="text-gray-700">
                                            Coordinates: {claimResponse.claim.geolocation.coordinates.join(', ')}
                                        </p>
                            ...
                            {/* Uploaded Photos */}
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                <h3 className="text-lg font-semibold text-gray-900 mb-4">Submitted Photos</h3>
                                <div className="grid grid-cols-3 gap-4">
